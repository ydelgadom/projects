...
!------------------------------------------------------------------------
  ...
  psum  = psum + abs(pp)*boltz
  p2sum = p2sum + abs(pp)**2*boltz      
  ...
  print*
  print*, "U/V      = ", ssum/(12*zz)
  print*, "C/V      = ", s2sum/(12*zz) - (ssum/zz)**2/12
  print*, "P/V      = ", psum/(12*zz)
  print*, "chi_P/V  = ", p2sum/(12*zz) - (psum/zz)**2/12
  print*   
  print*
  print*, "Done."
  print*
